...
public class Menu implements Serializable{
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(id, menu.id) &&
				...
				Objects.equals(note, menu.note) &&
				Objects.equals(parentId, menu.parentId) &&
				Objects.equals(permission, menu.permission) &&
				Objects.equals(createdUser, menu.createdUser) &&
				Objects.equals(createdTime, menu.createdTime) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, name, url, type, sort, note, parentId, permission, createdUser, createdTime, modifiedUser, modifiedTime);
	}
